...
// Source: C:\Users\Administrator\Desktop\JGEBCamp\webook\internal\repository\user.go
...
func (m *MockUserRepository) Profile(ctx context.Context, u domain.User) (domain.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) Profile(ctx, u interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Profile", reflect.TypeOf((*MockUserRepository)(nil).Profile), ctx, u)
}
