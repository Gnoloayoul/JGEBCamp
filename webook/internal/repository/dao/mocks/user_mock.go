...
// Source: C:\Users\Administrator\Desktop\JGEBCamp\webook\internal\repository\dao\user.go
...
func (mr *MockUserDAOMockRecorder) Edit(ctx, u interface{}) *gomock.Call {
...
func (m *MockUserDAO) Profile(ctx context.Context, u dao.User) (dao.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserDAOMockRecorder) Profile(ctx, u interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Profile", reflect.TypeOf((*MockUserDAO)(nil).Profile), ctx, u)
}
